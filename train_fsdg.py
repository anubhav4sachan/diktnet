...
from modules.models import LAPtrHRED, ZeroShotLAPtrHRED
from zsdg.modules.models import PtrHRED, ZeroShotPtrHRED
...
def get_data_loader(config):
    if len(config.laed_z_folders):
        return data_loaders.ZslDSTCDataLoader
...
def main(config):
    ...
    evaluator = evaluators.BleuEntEvaluator("DSTC", train_client.ent_metas)
